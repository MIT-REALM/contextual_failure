param use2DMap=True
param map = localPath('/home/anjali/carla_sim/models/Town01.xodr')
...
# Camera sensor attached to the ego vehicle
camera = new Camera on ego,
    with offset (1.5, 0, 2.4),  # Position relative to the ego vehicle (x, y, z)
    with fieldOfView 110,       # Field of view in degrees
    with width 1920,            # Image width
    with height 1080,           # Image height
    name "Egocamera"
