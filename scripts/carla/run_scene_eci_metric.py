...
def custom_posterior(Z):
    ...
    # home_dir = f"/home/anjali/bayes_human/carla_sim/data_corl/experiment_logs_ECI_metric/seed_{seed}"
    home_dir = f'/home/anjali/bayes_human/carla_sim/data_corl/experiment_logs_ECI_metric/seed_{seed}_{punchout_radius}_{delta_light}_{delta_dist}_{num_iter}_{num_init}'
...
def get_costs(object_list,ego_brake,lead_brake, sun_altitude):
    ...
    directory = f'/home/anjali/bayes_human/carla_sim/data_corl/experiment_logs_ECI_metric/seed_{seed}_{punchout_radius}_{delta_light}_{delta_dist}_{num_iter}_{num_init}/experiment_logs_{ego_brake:.2f}_{lead_brake:.2f}_{sun_altitude:.2f}'
...
def fail_bo(num_iter,bounds,X,Y,constraints,func,punchout_radius=0.1):
    ...
    if New:
        ...
        file = open(f"/home/anjali/bayes_human/carla_sim/data_corl/experiment_logs_ECI_metric/seed_{seed}_{punchout_radius}_{delta_light}_{delta_dist}_{num_iter}_{num_init}.pkl", "rb")
    ...
    while id_ < num_actual:
        ...
        file = open(f"/home/anjali/bayes_human/carla_sim/data_corl/experiment_logs_ECI_metric/seed_{seed}_{punchout_radius}_{delta_light}_{delta_dist}_{num_iter}_{num_init}.pkl", "wb")
...
def prepare_initial_model(num_init,seed):
    ...
    if New:
        for x in X:
            ...
            data = {'X':X, 'y_data':Y[1:,:]}
            file = open(f"/home/anjali/bayes_human/carla_sim/data_corl/experiment_logs_ECI_metric/seed_{seed}/initial_data.pkl", "wb")
            pickle.dump(data,file )
            file.close()
    if not New:
        file = open(f"/home/anjali/bayes_human/carla_sim/data_corl/experiment_logs_ECI_metric/seed_{seed}/initial_data.pkl", "rb")
        data_exists = pickle.load(file )
        file.close()
